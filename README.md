...
<body>
    <div class="container">
        <h3 class="text">SAMAKASH.R.S(212223230182)</h3>
...
input {
    text-align: right;
    border-radius: 21px;
    border: 2px solid rgb(190, 224, 16);
    padding: 20px;
...
```
## OUTPUT:
![alt text](<sam/Screenshot 2024-04-27 164626.png>)
![alt text](<sam/Screenshot 2024-04-27 164633.png>)
## RESULT:
